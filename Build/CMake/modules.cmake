...
function(define_module MODULE_NAME)
    ...
    cmake_parse_arguments(DEFINE_MODULE "INCLUDES_MODULE_BASE;HEADER_ONLY" "THIRD_PARTY" "DEPENDENCIES;SYSTEM_LIBS;LINK_LIBS;EXPLICIT_SOURCES" ${ARGN})
    ...
    if(DEFINE_MODULE_SYSTEM_LIBS)
        if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
            foreach(SYSLIB ${DEFINE_MODULE_SYSTEM_LIBS})
                unset(LIB CACHE)
                find_library(LIB ${SYSLIB})
                list(APPEND MODULE_SYS_LIBS "${LIB}")
            endforeach()
        elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
            foreach(SYSLIB ${DEFINE_MODULE_SYSTEM_LIBS})
                list(APPEND MODULE_SYS_LIBS "${SYSLIB}")
            endforeach()
        endif()

        set_property(GLOBAL PROPERTY MODULE_${MODULE_NAME}_SYS_LIBS "${MODULE_SYS_LIBS}")
    endif()
...
function(add_module MODULE_NAME)
    ...
    get_property(MODULE_SYS_LIBS GLOBAL PROPERTY "MODULE_${MODULE_NAME}_SYS_LIBS")
    if(NOT IS_HEADER_ONLY)
        ...
        target_link_libraries(${MODULE_PARENT} PUBLIC ${MODULE_LINK_LIBS} ${MODULE_SYS_LIBS})
    endif()
endfunction()